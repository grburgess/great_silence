---
title: "Config"
description: "API reference for great_silence.visualization.threejs.config"
sidebar:
  order: 38
---
...
**Module:** `great_silence.visualization.threejs.config`

Configuration for Three.js visualization system.

```python
from great_silence.visualization.threejs.config import ...
```

## Classes


### ThreeJSConfig <span class="badge">dataclass</span>
